# Hi, I'm Jakrawut Sainate (BiG) 👋
### 🚀 Software Developer | DevOps Enthusiast | Cloud Infrastructure Explorer
I am a **Junior Software Developer** who is deeply passionate about **DevOps**, cloud architecture, and modern backend systems. While my primary role is writing code and building full-stack applications, I love getting my hands dirty with Linux servers, container orchestration, and reverse proxies. I believe the best code is written by developers who understand the infrastructure it runs on.
---
### 🛠 My Tech Stack & Tools
#### 🤖 AI-Powered Workflow
...
![CI/CD](https://img.shields.io/badge/CI/CD-FF6A00?style=for-the-badge&logo=github-actions&logoColor=white)
---
### 🔥 Featured Work: Albaly Insights Dashboard
**[Full-Stack App + Kubernetes Infrastructure]**
As a developer who loves DevOps, I didn't just write the code; I built the infrastructure for it:
* **Development**: Built with Next.js 16, React 19, and Tailwind CSS using a strict **Clean Architecture** approach. 
